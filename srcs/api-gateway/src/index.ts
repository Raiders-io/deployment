...
const MESSAGING_SERVICE_URL: string = process.env.MESSAGING_SERVICE_URL || 'http://messaging-service:3334';
const AUTH_SERVICE_URL: string = process.env.AUTH_SERVICE_URL || 'http://auth-service:3333';
