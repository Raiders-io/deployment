...
This project provides the reverse proxy for the project [Transcendence](https://github.com/Raiders-io/Transcendence) and the monitoring layer. You can access the frontend at `https://localhost:4443/`.
